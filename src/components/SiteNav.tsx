      ...
      <div className="mx-auto flex h-14 max-w-6xl items-center justify-between gap-2 px-3 sm:h-16 sm:gap-4 sm:px-6">
        ...
        >
          <Image
            ...
            width={40}
            height={40}
            className="size-9 shrink-0 rounded-lg ring-1 ring-white/20 sm:size-10"
            priority
          />
              ...
              <nav className="mt-6 flex flex-col gap-1 px-2">
                {links.map((link) => (
                  <a
                    ...
                    className="rounded-lg px-3 py-3 text-base font-medium text-foreground hover:bg-muted hover:text-primary"
                  >
                    {link.label}
                  </a>
                ))}
